                ...
                <section className="prof-section" id="ordererView" hidden data-od-id="profile-orderer">
                  ...
                  <div>
                    ...
                    <button className="rowlink" type="button" id="pickupBtnOrderer">
                      ...
                      <span className="rowflex"><span className="ro" id="pickupValOrderer">圖書館 1F 大廳</span><span className="rowlink__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 6l6 6-6 6" /></svg></span></span>
                    </button>
                  </div>
                </section>
