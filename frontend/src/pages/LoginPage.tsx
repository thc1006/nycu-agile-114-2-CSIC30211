        ...
        <main className="login" id="main">
            ...
            <div className="login__form">
              <div className="login__card">
                <h2>登入</h2>
                <p className="sub">用學校 Email 進入，選擇這次要使用的身份。<br />還沒有帳號？<a className="sub-link" href="register.html">前往註冊</a></p>
