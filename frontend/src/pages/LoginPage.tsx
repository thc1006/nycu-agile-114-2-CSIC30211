              ...
              <div className="login__card">
                ...
                <form id="loginForm" noValidate>
                  ...
                  <div className="field">
                    ...
                    <input className="control" type="password" id="pw" name="pw" placeholder="輸入密碼" autoComplete="current-password" defaultValue="demo1234" />
                    <div className="field__error"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" /><path d="M12 8v4M12 16h.01" /></svg>請輸入密碼</div>
                  </div>
        
                  <label style={{ fontSize: "var(--text-sm)", fontWeight: "600", display: "block", marginBottom: "8px" }}>這次要進入哪一種視角？<span className="req">*</span></label>
                ...
                <p className="legal">繼續即代表你同意 <a href="#" data-legal="">服務條款</a> 與 <a href="#" data-legal="">隱私政策</a>。</p>
              </div>
            </div>
          </main>
      </>
