...
| Proposed | 提案中,尚未拍板 |
| Accepted | 已採用 |
| Superseded | 已被新 ADR 完全取代 |
| Amended by | 部分修訂:原決策仍有效,但某面向已被新 ADR 更新 |
| Deprecated | 不再適用 |
...
| [0005](0005-redis-lock-for-accept-concurrency.md) | 用 Redis 分散式鎖防止重複接單 | Accepted（鎖釋放機制 amended by 0007） |
| [0006](0006-pytest-pre-push-quality-gate.md) | pytest + pre-push hook 作為品質閘門 | Accepted（CI 已成為正式閘門） |
| [0007](0007-order-state-transitions.md) | 訂單狀態機 / 動作端點 / Lua 原子鎖 | Accepted |
| [0008](0008-bilateral-rating-model.md) | 雙向評價模型(HSETNX + 原子聚合) | Accepted |
